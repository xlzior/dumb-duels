...
struct TTCollisions {
    ...
    static let bottomBoundaryBitmask: UInt32 = 0x1 << 5
    ...
    static let landedBlockContactBitmask: UInt32 = landedBlockBitmask | controlBlockBitmask | wallBitmask | platformBitmask |
                                                   scoreLineBitmask | bottomBoundaryBitmask
