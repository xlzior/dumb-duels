...
struct ContactTestTypeBitMasks {
    static let contactTestTypeBitMaskMap: [ObjectIdentifier: UInt32] = [
    ...
    static func getBitMask(for categories: [any CollisionCategory]) -> UInt32 {
        ...
        for category in categories {
            let nextBitMask = contactTestTypeBitMaskMap[ObjectIdentifier(category.self)] ?? 0
