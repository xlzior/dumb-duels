...
struct TTCollisions {
    ...
    static let landedBlockCollideBitmask: UInt32 = landedBlockBitmask | controlBlockBitmask |
                                                   wallBitmask | platformBitmask
    static let controlBlockCollideBitmask: UInt32 = landedBlockBitmask | controlBlockBitmask |
                                                    wallBitmask | platformBitmask
